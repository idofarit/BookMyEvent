...
import CancelBookingBtn from "./_components/CancelBookingButton";
      ...
      <div className="flex flex-col gap-5 mt-5">
        {bookedEvents.map((booking) => {
          return (
            ...
            >
              <div className="bg-gray-700 p-5 text-white flex md:flex-row flex-col justify-between md:items-center">
